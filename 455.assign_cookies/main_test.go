...
func TestFindContentChildren(t *testing.T) {
	tests := []struct {
		...
		{"example1", []int{1, 2, 3}, []int{3}, 1},
		{"example2", []int{10, 9, 8, 7, 10, 9, 8, 7}, []int{10, 9, 8, 7}, 4},
		{"example3", []int{1, 2, 3}, []int{1, 1}, 1},
		{"example4", []int{1, 2}, []int{1, 2, 3}, 2},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			res := findContentChildren2(tt.g, tt.s)
			assert.Equal(t, tt.output, res)
		})
	}
}
